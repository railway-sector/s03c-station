import{jW as be,mf as we,pj as De,E1 as f,pa as w,pg as Ve,p0 as B,HF as r,rH as z,FE as ee,B6 as xe,p7 as y,l6 as te,ij as A,j1 as H,pk as Ee,Bw as ie,E7 as ne,p5 as S,ge as _,A4 as v,MD as se,zk as ae,ya as o,IN as re,g_ as Le,G as ye,fc as Se,nY as le,yo as oe,JY as Ce,HL as Me,tC as Ae,HI as $e,pb as Re,zC as F,nU as Te,n0 as ce,H4 as he,iL as de,lf as Ie,CX as G,K4 as j,iI as c,kY as q,GJ as pe,fy as ue,nX as Oe,Iq as O,iq as Ue,E4 as je,De as ze,jX as qe,tZ as V,IT as Ne,gI as k,G1 as We,Dh as Be,Cm as $,B8 as He,aW as X,xq as Fe,Kc as Ge,eW as ke,BQ as Xe,kw as Ke,tm as Ye,iP as C,kK as Je,Gm as K}from"./index-C2tWxZNz.js";import{t as Qe}from"./VisualElement-KKhiU7D9.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return true;
}`),e.contrastControlEnabled?n.uniforms.add(new B("frameColor",(i,s)=>i.colors),new f("globalAlphaContrastBoost",i=>i.globalAlphaContrastBoost)).code.add(r`float rgbToLuminance(vec3 color) {
...
}`)}const N=z(6);function ge(t){const e=new ee;e.include(xe),e.include(fe,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new y("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=H(D),d)),new Ee("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new y("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new y("pointDistanceSphere",(i,s)=>Ze(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new y("lineVerticalPlane",(i,s)=>et(i,s)),new w("lineVerticalStart",(i,s)=>tt(i,s)),new w("lineVerticalEnd",(i,s)=>it(i,s))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function M(t){return re(nt,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-z(2))))}function Ze(t,e){return _(U,t.pointDistanceOrigin,e.camera.viewMatrix),U[3]=ie(t.pointDistanceOrigin,t.pointDistanceTarget),U}function et(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,st),s=A(D,t.lineVerticalPlaneSegment.vector),a=Se(u,i,s);return A(a,a),me(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function tt(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function it(t,e){const n=le(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function me(t,e,n){return _(Y,t,n),v(d,e),d[3]=0,se(d,d,n),Le(Y,d,at)}const nt=oe(),u=o(),d=ae(),st=o(),D=o(),Y=o(),at=Ce(),U=ae(),rt=Object.freeze(Object.defineProperty({__proto__:null,build:ge,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new ee;e.include(fe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Me("modelView",(a,{camera:l})=>Ae(ot,l.viewMatrix,a.origin)),new $e("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new Re("pixelToNDC",({camera:a})=>re(lt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
