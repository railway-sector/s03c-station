import{FD as te,qD as ie,u0 as re,qz as ae,pb as se,pc as oe,HE as o,Cl as ne,HH as ce,E7 as le,zC as y,K_ as pe,pd as de,FY as U,sq as he,Jx as ve,o$ as ue,p7 as me,p0 as fe,u1 as R,ny as I,zF as ge,jT as Se,nu as Pe,fy as ye,n0 as _e,GI as we,H3 as ze,iL as xe,eU as W,MB as q,mc as $e,E2 as H,ra as M,qA as be,wD as ke,FX as Ve,zG as Oe,u2 as B,jU as Y,qE as Te,pe as Ce,FZ as De,iI as d,kY as We,HI as Le,tZ as m,EL as Me,Cj as L,ro as je,nz as G,AH as Fe,p9 as Ae,HJ as Ee,p2 as Ne,Ip as J,bF as Ue,ge as Z,ya as K,ef as Re}from"./index-DTjuCda1.js";function Q(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),_&&(e.include(I),S.constants.add("relativeMarkerSize","float",ge/R).constants.add("relativeTipLineWidth","float",Se).code.add(o`
  ...
  `)),e.include(Pe,r),e.include(I),S.main.add(o`
    discardBySlice(vpos);
    ...
    outputColorHighlightOLID(applySlice(finalColor, vpos), finalColor.rgb);`),e}const Ie=Object.freeze(Object.defineProperty({__proto__:null,build:Q},Symbol.toStringTag,{value:"Module"}));let j=class extends _e{constructor(e,a){super(e,a,we(X(a))),this.shader=new ze(Ie,()=>xe(()=>Promise.resolve().then(()=>Je),void 0))}_makePipelineState(e,a){const{output:t,space:_,hasOccludees:w}=e;return W({blending:Ve(t,!1,e.emissionDimmingPass),depthTest:_===0?null:ke(t),depthWrite:be(e),colorWrite:M,stencilWrite:w?H:null,stencilTest:w?a?q:$e:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(e){return e.occluder?(this._occluderPipelineTransparent=W({blending:Y,depthTest:B,depthWrite:null,colorWrite:M,stencilWrite:null,stencilTest:Oe}),this._occluderPipelineOpaque=W({blending:Y,depthTest:B,depthWrite:null,colorWrite:M,stencilWrite:Ce,stencilTest:Te}),this._occluderPipelineMaskWrite=W({blending:null,depthTest:De,depthWrite:null,colorWrite:null,stencilWrite:H,stencilTest:q})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,a,t){return t?this._occludeePipelineState:e.occluder===11?this._occluderPipelineTransparent??super.getPipeline(e,a,t):e.occluder===10?this._occluderPipelineOpaque??super.getPipeline(e,a,t):this._occluderPipelineMaskWrite??super.getPipeline(e,a,t)}};function X(r){const e=ye().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return r.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),r.hasVVOpacity&&e.f32("opacityFeatureAttribute"),r.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),r.worldSpace&&e.vec3f16("normal"),e.freeze()}j=d([We("esri.views.3d.webgl-engine.shaders.LineMarkerTechnique")],j);class h extends Le{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}d([m({count:3})],h.prototype,"space",void 0),d([m({count:2})],h.prototype,"anchor",void 0),d([m()],h.prototype,"occluder",void 0),d([m()],h.prototype,"writeDepth",void 0),d([m()],h.prototype,"hideOnShortSegments",void 0),d([m()],h.prototype,"hasCap",void 0),d([m()],h.prototype,"hasTip",void 0),d([m()],h.prototype,"hasVVSize",void 0),d([m()],h.prototype,"hasVVColor",void 0),d([m()],h.prototype,"hasVVOpacity",void 0),d([m()],h.prototype,"hasOccludees",void 0),d([m()],h.prototype,"hasScreenSizePerspective",void 0);class Qe extends Me{constructor(e,a){super(e,He),this.produces=new Map([[2,t=>t===10||L(t)&&this.parameters.renderOccluded===8],[3,t=>je(t)],[10,t=>G(t)&&this.parameters.renderOccluded===8],[11,t=>G(t)&&this.parameters.renderOccluded===8],[4,t=>L(t)&&this.parameters.writeDepth],[8,t=>L(t)&&!this.parameters.writeDepth],[18,t=>L(t)||t===10]]),this.intersectDraped=void 0,this._configuration=new h(a)}updateConfiguration(e){super.updateConfiguration(e),this._configuration.space=e.slot===18?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=e.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null}get visible(){return this.parameters.color[3]>=Fe}intersect(){}createBufferWriter(){return new Be(X(this.parameters),this.parameters)}createGLMaterial(e){return new qe(e)}}class qe extends Ne{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const a=this._material.parameters.markerPrimitive;return a!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(a,this._markerPrimitive)}),this._markerPrimitive=a),this.getTechnique(j,e)}}class He extends Ae{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Be{constructor(e,a){this.layout=e,this._parameters=a}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,a,t,_,w){if(w==null)return;const{buffer:f,offset:k}=w,i=t.get("position").data,S=i.length/3;let g=[1,0,0];const l=t.get("normal");this._parameters.worldSpace&&l!=null&&(g=l.data);let c=1,F=0;this._parameters.vvSize?F=t.get("sizeFeatureAttribute").data[0]:t.has("size")&&(c=t.get("size").data[0]);let x=[1,1,1,1],A=0;this._parameters.vvColor?A=t.get("colorFeatureAttribute").data[0]:t.has("color")&&(x=t.get("color").data);let E=0;this._parameters.vvOpacity&&(E=t.get("opacityFeatureAttribute").data[0]);const z=new Float32Array(f.buffer),P=Ee(f.buffer),V=new Uint8Array(f.buffer);let p=k*(this.layout.stride/4);const $=z.BYTES_PER_ELEMENT/P.BYTES_PER_ELEMENT,ee=4/$,b=(n,T,v,u)=>{z[p++]=n[0],z[p++]=n[1],z[p++]=n[2],Re(T,n,P,p*$),p+=ee;let s=p*$;if(P[s++]=v[0],P[s++]=v[1],p=Math.ceil(s/$),this._parameters.vvColor)z[p++]=A;else{const C=Math.min(4*u,x.length-4),D=4*p++;V[D]=255*x[C],V[D+1]=255*x[C+1],V[D+2]=255*x[C+2],V[D+3]=255*x[C+3]}this._parameters.vvOpacity&&(z[p++]=E),s=p*$,this._parameters.vvSize?(z[p++]=F,s+=2):P[s++]=c,this._parameters.worldSpace&&(P[s++]=g[0],P[s++]=g[1],P[s++]=g[2]),p=Math.ceil(s/$)},N=(n,T)=>{const v=J(Ye,i[3*n],i[3*n+1],i[3*n+2]),u=Ge;let s=n+T;do J(u,i[3*s],i[3*s+1],i[3*s+2]),s+=T;while(Ue(v,u)&&s>=0&&s<S);e&&(Z(v,v,e),Z(u,u,e)),b(v,u,[-1,-1],n),b(v,u,[1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,1],n)},O=this._parameters.placement;O!=="begin"&&O!=="begin-end"||N(0,1),O!=="end"&&O!=="begin-end"||N(S-1,-1)}}const Ye=K(),Ge=K(),Je=Object.freeze(Object.defineProperty({__proto__:null,build:Q},Symbol.toStringTag,{value:"Module"}));export{Qe as g};
