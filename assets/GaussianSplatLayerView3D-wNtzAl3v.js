...
return -0.5 * dot(conic, vec3(x * x, 2.0 * x * y, y * y));
  ...
  `)}const Zt=""+(se-1),Qt=`${Math.log2(se)}`,La=""+(ye-1),Ha=`${Math.log2(ye)}`;let mi=class extends Tt{constructor(){super(...arguments),this.tileCameraPosition=O(),this.cameraDelta=O()}};function gi(n){n.code.add(x`float unpackOpacity(uvec4 packedGaussian) {
...
depth /= 16777215.0;
return depth;
}`)}class le extends Ni{constructor(e){super(),this.spherical=e,this.alphaCutoff=1,this.fadingEnabled=!1,this.clippingEnabled=!1,this.receiveShadows=!1,this.hasShadowHighlights=!1,this.output=0,this.hasEmission=!1,this.receiveAmbientOcclusion=!1,this.receiveGlobalIllumination=!1,this.pbrMode=0,this.useCustomDTRExponentForWater=!1,this.useFillLights=!1,this.hasColorTexture=!0}}function ja(n){switch(n){case 2:return .005;case 0:return .05;default:return .01}}C([he({count:3})],le.prototype,"alphaCutoff",void 0),C([he()],le.prototype,"fadingEnabled",void 0),C([he()],le.prototype,"clippingEnabled",void 0),C([he()],le.prototype,"receiveShadows",void 0),C([he()],le.prototype,"hasShadowHighlights",void 0),C([he({count:12})],le.prototype,"output",void 0),C([he()],le.prototype,"receiveAmbientOcclusion",void 0),C([he()],le.prototype,"receiveGlobalIllumination",void 0);class Ft extends mi{constructor(){super(...arguments),this.clipMinCameraRelative=O(),this.clipMaxCameraRelative=O(),this.focalLength=-1,this.minSplatRadius=-1,this.tanFov=Dt(),this.origin=O()}}function xi(n){const{clippingEnabled:e,hasSlicePlane:t,receiveShadows:i,spherical:a}=n,s=new tt;s.varyings.add("vColor","vec4"),s.varyings.add("conicOpacity","vec4"),s.varyings.add("gaussianLogAlphaCutoff","float"),s.varyings.add("offsetFromCenter","vec2"),Jt(n)&&s.varyings.add("fragmentPositionCameraRelative","vec3"),s.vertex.uniforms.add(new Be("splatOrderTexture",c=>c.splatOrder),new Be("splatFadingTexture",c=>c.splatFading),new Be("splatAtlasTexture",c=>c.splatAtlas),new vt("focalLength",c=>c.focalLength),new vt("minSplatRadius",c=>c.minSplatRadius),new Ui("tanFov",c=>c.tanFov),new We("inverseScreenSize",({camera:c})=>Mt(Wa,1/c.fullWidth,1/c.fullHeight)),new Ne("proj",c=>c.camera.projectionMatrix),new Ne("view",c=>c.camera.viewMatrix),new We("nearFar",c=>c.camera.nearFar),new Bt("cameraPosition",c=>c.camera.eye)),e&&(s.vertex.uniforms.add(new xe("clipMin",c=>c.clipMinCameraRelative),new xe("clipMax",c=>c.clipMaxCameraRelative)),s.fragment.uniforms.add(new xe("clipMin",c=>c.clipMinCameraRelative),new xe("clipMax",c=>c.clipMaxCameraRelative))),s.vertex.include(gi),s.vertex.include(fi),s.vertex.include(vi),s.vertex.include(pi),s.vertex.include(Ye),s.vertex.include(_t,n),i?(s.fragment.uniforms.add(new Bt("cameraPosition",c=>c.camera.eye)),s.fragment.include(Vt,n)):s.vertex.include(Vt,n),s.include(Yi,n),Xi(i?s.fragment:s.vertex),Zi(i?s.fragment:s.vertex),i&&s.include(Qi,n),s.outputs.add("fragColor","vec4",0),s.outputs.add("fragDepthColor","vec4",1);const r=ja(n.alphaCutoff),o=Math.log(r),u=x`float groundLightAlignment = dot(groundNormal, mainLightDirection);
