import{kG as Pe,mZ as be,pZ as we,E_ as f,pO as w,pU as De,pH as W,IE as r,FT as j,GG as Y,BI as Ve,pL as C,oI as ee,j7 as T,jP as H,p_ as xe,C7 as te,F5 as ie,pJ as M,bs as m,AL as v,Nn as ne,zY as se,yN as o,A_ as ae,hM as Ee,vg as ye,fx as Le,lQ as re,z3 as le,KT as Se,IM as Ce,u0 as Me,IK as Ae,pP as $e,Aa as B,oA as Te,rR as oe,IF as ce,jz as he,mh as Re,DZ as G,KU as U,jw as c,lH as z,HO as de,f$ as pe,oy as Oe,Jq as O,jd as Ie,F1 as Ue,Ec as qe,kI as je,un as V,kH as ze,rU as k,Fa as Ne,Ee as Fe,D4 as R,BK as We,xO as He,L5 as Be,f8 as Ge,Ca as ke,l5 as Ke,to as Ze,jB as A,lv as Je,Hy as K}from"./index-Ap12ujN2.js";import{t as Qe}from"./VisualElement-DaUmfuYe.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=j(6);function fe(t){const e=new Y;e.include(Ve),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),ee(D,D,u),T(d,D),d[3]=H(D),d)),new xe("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new M("angleCutoff",s=>$(s)),new C("heightPlane",(s,a)=>ge(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new M("angleCutoff",i=>$(i)),new C("pointDistanceSphere",(i,s)=>Xe(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function $(t){return ae(it,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function Xe(t,e){return m(I,t.pointDistanceOrigin,e.camera.viewMatrix),I[3]=te(t.pointDistanceOrigin,t.pointDistanceTarget),I}function Ye(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,nt),s=T(D,t.lineVerticalPlaneSegment.vector),a=Le(u,i,s);return T(a,a),ge(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function et(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function tt(t,e){const n=re(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function ge(t,e,n){return m(Z,t,n),v(d,e),d[3]=0,ne(d,d,n),Ee(Z,d,st)}const it=le(),u=o(),d=se(),nt=o(),D=o(),Z=o(),st=Se(),I=se(),at=Object.freeze(Object.defineProperty({__proto__:null,build:fe,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new Y;e.include(ue,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Ce("modelView",(a,{camera:l})=>Me(lt,l.viewMatrix,a.origin)),new Ae("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new $e("pixelToNDC",({camera:a})=>ae(rt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
