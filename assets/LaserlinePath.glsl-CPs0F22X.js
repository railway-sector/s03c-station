import{jW as be,mf as we,pj as De,E1 as f,pa as w,pg as Ve,p0 as H,HE as r,rH as z,FD as ee,B6 as xe,p7 as L,l6 as te,ij as A,j1 as B,pk as Ee,Bw as ie,E7 as ne,p5 as S,ge as _,A4 as v,MC as se,zk as ae,ya as o,IM as re,g_ as ye,G as Le,fc as Se,nY as le,yo as oe,JX as Ce,HK as Me,tC as Ae,HH as $e,pb as Re,zC as F,nU as Te,n0 as ce,H3 as he,iL as de,lf as Ie,CX as G,K3 as j,iI as c,kY as q,GI as pe,fy as ue,nX as Oe,Ip as O,iq as Ue,E4 as je,De as ze,jX as qe,tZ as V,IS as Ne,gI as k,G0 as We,Dh as He,Cm as $,B8 as Be,aW as X,xq as Fe,Kb as Ge,eW as ke,BQ as Xe,kw as Ke,tm as Qe,iP as C,kK as Ye,Gl as K}from"./index-DTjuCda1.js";import{t as Ze}from"./VisualElement-BVY58svY.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return true;
}`),e.contrastControlEnabled?n.uniforms.add(new H("frameColor",(i,s)=>i.colors),new f("globalAlphaContrastBoost",i=>i.globalAlphaContrastBoost)).code.add(r`float rgbToLuminance(vec3 color) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new L("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=B(D),d)),new Ee("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new L("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new L("pointDistanceSphere",(i,s)=>Je(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new L("lineVerticalPlane",(i,s)=>et(i,s)),new w("lineVerticalStart",(i,s)=>tt(i,s)),new w("lineVerticalEnd",(i,s)=>it(i,s))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
