import{l5 as be,nt as we,qG as De,FJ as f,qx as w,qD as Ve,qn as B,Js as r,te as j,Hp as ee,CK as xe,qu as y,mj as te,jv as A,kc as F,qH as Ee,D7 as ie,FP as ne,qs as S,h6 as _,BI as v,Or as se,AZ as ae,zN as o,KC as re,i3 as Le,G as ye,fW as Se,pi as le,A0 as oe,LN as Ce,Jy as Me,v8 as Ae,Jv as $e,qy as Re,Bf as H,pe as Te,om as ce,IT as he,jW as de,ms as Oe,EE as G,LV as U,jT as c,m9 as z,Iw as pe,gm as ue,ph as Ie,Kf as I,jB as qe,FM as Ue,EW as je,l6 as ze,vu as V,KI as Ne,hE as k,HO as We,EZ as Be,DZ as $,CM as Fe,bi as J,z1 as He,M1 as Ge,fD as ke,Dr as Je,lI as Ke,uU as Ze,j$ as C,lW as Xe,I9 as K}from"./index-Dn9zTFVL.js";import{t as Qe}from"./VisualElement-FXXg-bFT.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=j(6);function ge(t){const e=new ee;e.include(xe),e.include(fe,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new y("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=F(D),d)),new Ee("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new y("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new y("pointDistanceSphere",(i,s)=>Ye(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
...
color = max(color, intersectsLineColor * intersectsLineAlpha);
    ...
    ${H(s,r`vec3 startUp = vec3(0, 0, 1);`)}
    ${H(s,r`vec3 endUp = vec3(0, 0, 1);`)}
