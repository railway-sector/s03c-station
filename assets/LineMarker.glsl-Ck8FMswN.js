import{GG as ee,ra as te,up as ie,ul as re,r6 as ae,pP as se,pQ as oe,IE as o,D1 as ne,IK as ce,F5 as le,Aa as z,LS as pe,pR as de,H1 as N,sT as he,pF as ue,pG as ve,pL as me,pH as fe,uq as R,od as U,Ae as ge,kD as Se,o9 as Pe,f$ as ye,rR as we,HO as ze,IF as _e,jz as xe,LP as L,IG as I,mU as $e,r7 as B,Ku as M,r9 as be,sU as Te,xj as ke,BE as Ve,BF as k,r8 as Oe,pS as De,Af as q,kE as H,Kx as We,ur as Ce,kF as Le,jw as c,lH as Me,E$ as Ae,un as d,jN as Fe,kz as je,Mp as G,Bc as Ee,F3 as Ne,IL as Re,IH as Ue,Jq as K,bT as Ie,bs as Q,yN as Y,Mq as Be}from"./index-Ap12ujN2.js";function J(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:_}=t,v=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(U),S.constants.add("relativeMarkerSize","float",ge/R).constants.add("relativeTipLineWidth","float",Se).code.add(o`
