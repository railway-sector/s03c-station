import{FE as te,qD as ie,u0 as re,qz as ae,pb as se,pc as oe,HF as o,Cl as ne,HI as ce,E7 as le,zC as y,K$ as pe,pd as de,FZ as U,sq as he,Jy as ve,o$ as ue,p7 as me,p0 as fe,u1 as R,ny as I,zF as ge,jT as Se,nu as Pe,fy as ye,n0 as _e,GJ as we,H4 as ze,iL as xe,eU as W,MC as q,mc as $e,E2 as H,ra as M,qA as be,wD as ke,FY as Ve,zG as Oe,u2 as B,jU as Y,qE as Te,pe as Ce,F_ as De,iI as d,kY as We,HJ as Le,tZ as m,EL as Me,Cj as L,ro as je,nz as G,AH as Fe,p9 as Ae,HK as Ee,p2 as Ne,Iq as J,bF as Ue,ge as K,ya as Z,ef as Re}from"./index-C2tWxZNz.js";function Q(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
